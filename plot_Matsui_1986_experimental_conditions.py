...
plt.plot(x, y_mid_to_far_infrared, label="Mid- to far-infrared (1.5–4.8 μm)")
plt.plot(x, y_far_infrared, label="Far-infrared (6–20 μm)")
...
#     plt.text(position, 1500, label, ha="center", color="black", fontsize=10)
...
#
# plt.figure(figsize=(6,3.5))
# plt.plot(x, y_near_to_mid_infrared, label= "A (0.72 - 2.7 µm)")
# plt.plot(x, y_mid_to_far_infrared, label= "B (1.5 - 4.8 µm)")
# plt.plot(x, y_far_infrared, label= "C (6 - 20 µm)")
# plt.fill_between( x, y_near_to_mid_infrared, alpha=0.5)
# plt.fill_between( x, y_mid_to_far_infrared, alpha=0.5)
# plt.fill_between( x, y_far_infrared, alpha=0.5)
#
